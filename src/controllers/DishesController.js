...
// Define a classe DishesController
class DishesController {
  ...
  async index(request, response) {
    ...
    if (ingredients) {
      // Separa os ingredientes da query em um array e remove os espaços em branco
      ...
      dishes = await knex("ingredients")
        ...
        // Faz uma pesquisa por título e pelos ingredientes selecionados
      ...
      // Faz uma pesquisa apenas por título
  ...
  // Método para mostrar os detalhes de um prato
...
// Exporta a classe DishesController
